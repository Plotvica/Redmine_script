...
function loadConfig(rootDir) {
  ...
  const redmine = {
    ...
    requestConcurrency: clampNumber(process.env.REDMINE_REQUEST_CONCURRENCY, 1, 5, 2),
    requestDelayMs: clampNumber(process.env.REDMINE_REQUEST_DELAY_MS, 0, 5000, 150),
    requestRetries: clampNumber(process.env.REDMINE_REQUEST_RETRIES, 0, 8, 4),
    requestRetryBaseMs: clampNumber(process.env.REDMINE_REQUEST_RETRY_BASE_MS, 250, 30000, 1500),
