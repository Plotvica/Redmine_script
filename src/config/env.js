...
function loadConfig(rootDir) {
  ...
  const redmine = {
    ...
    requestConcurrency: clampNumber(process.env.REDMINE_REQUEST_CONCURRENCY, 1, 5, 1),
    requestDelayMs: clampNumber(process.env.REDMINE_REQUEST_DELAY_MS, 0, 5000, 250),
